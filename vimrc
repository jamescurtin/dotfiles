...
"
" " Enable omnicompletion (to use, hold Ctrl+X then Ctrl+O while in Insert
" mode.
...
" "augroup END
"
" " Highlight characters that go over 80 columns (by drawing a border on the
" 81st)
...
"                             foldmethod=expr foldlevel=0 foldcolumn=0<CR>
"
"                             " Easily create boxy characters for '0, 1, 3'
"                             scale
"                             map ,m
"                             :s/0/▁/e<CR>:s/1/▅/e<CR>:s/3/▇/e<CR>:nohlsearch<cr>:echo
"                             <cr>
"
...
"                                   endfunction
"
"                                   " Make Vim built-in explorer cool enough
"                                   so I don't have to use NERDTree
"                                   " Toggle Vexplore with Ctrl-E
"                                   function! ToggleVExplorer()
"                                     if exists("t:expl_buf_num")
"                                           let expl_win_num =
"                                           bufwinnr(t:expl_buf_num)
"                                                 if expl_win_num != -1
"                                                           let cur_win_nr =
"                                                           winnr()
"                                                                     exec
